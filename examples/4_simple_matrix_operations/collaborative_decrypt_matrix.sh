...
do
	...
	./COLLAGENE.sh -partial_decrypt_matrix SITE_${decrypting_i_site} ${enc_matrix_file} ${decrypting_i_site} 0 ${enc_matrix_file}_partdec_by_${decrypting_i_site}.partdec
done
