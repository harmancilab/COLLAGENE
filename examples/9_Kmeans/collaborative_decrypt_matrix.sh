...
ls ${enc_matrix_file}_partdec_by_*.partdec > ${enc_matrix_file}_PARTDECS.list
n_partdecs=`wc -l ${enc_matrix_file}_PARTDECS.list | awk {'print $1'}`
echo "Pooling ${n_partdecs} parts.."
./COLLAGENE.sh -pool_partially_decrypted_matrices SITE_${i_site} ${enc_matrix_file}_PARTDECS.list ${enc_matrix_file}_collaborative_dec.bin
